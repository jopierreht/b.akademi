...
import '../../../pages/main_page/home_page/single_course_page/single_content_page/web_view_page.dart';
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Adding the 'Delete Account' button before login history section
                Center(
                  child: GestureDetector(
                    onTap: () {
                      // Navigate to your URL
                      nextRoute(WebViewPage.pageName, arguments: [
                        'https://akademi.briye.co/panel/setting/step/1',
                        'Delete Account',
                        false,
                        LoadRequestMethod.get // Ensure LoadRequestMethod is defined
                      ]);
                    },
                    behavior: HitTestBehavior.opaque,
                    child: Text(
                      'Delete Account',
                      style: style14Regular().copyWith(color: Colors.redAccent), // Red accent for visibility
                      textAlign: TextAlign.center,
                    ),
                  ),
                ),

                space(30), // Space after button before login history
