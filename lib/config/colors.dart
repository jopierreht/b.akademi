...
/// Main Color
Color green77() => const Color(0xff000000);
Color green91() => const Color(0xffa2a2a3);
Color blue64() => const Color(0xff000000);
...
Color green63 = const Color(0xff000000);

// grey Shade
Color grey33 = const Color(0xff2F3133);
Color grey3A = const Color(0xff000000);
...
Color green4B = const Color(0xff000000);
